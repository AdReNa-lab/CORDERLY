function varargout = Colloidal_Ordering_GUI(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Colloidal_Ordering_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @Colloidal_Ordering_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Colloidal_Ordering_GUI_OpeningFcn(hObject, ~, handles, varargin)
...
function varargout = Colloidal_Ordering_GUI_OutputFcn(~, ~, handles) 
